...
public class FVQuickUserRegistration {
    ...
    public Object run(DocumentModel registrationRequest) throws Exception {
        ...
        try {
            ...
            String registrationId = utilCommon.postCondition(registrationService, registrationRequest, info, null,
                    validationMethod, true); // we always autoAccept quick registration
