...
public class RestPassword extends ModuleRoot {
    ...
    public Object sendPasswordMail() throws NuxeoException {
        ...
        email = email.trim();
        CreatePasswordResetLinkUnrestricted runner = new CreatePasswordResetLinkUnrestricted(getDefaultRepositoryName(),
                email);
    ...
    public Object submitNewPassword() throws URISyntaxException {
        ...
        SetNewPasswordUnrestricted runner = new SetNewPasswordUnrestricted(getDefaultRepositoryName(), password,
                passwordKey);
        runner.runUnrestricted();
        ...
        String errorMessage = runner.getErrorMessage();
        if (errorMessage != null) {
            return redisplayFormWithErrorMessage("submitNewPassword", ctx.getMessage(errorMessage), formData).arg("key",
                    passwordKey);
        } else {
            return redisplayFormWithInfoMessage("submitNewPassword", ctx.getMessage("label.submitNewPassword.saved"),
