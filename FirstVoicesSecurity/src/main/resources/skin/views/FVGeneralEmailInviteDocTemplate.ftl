...
Thank you for creating an account on FirstVoices.com.<br/><br/>

Your username is: ${userinfo.login} (case-sensitive)<br/>

In order to create a password, please follow this link:<br/>
