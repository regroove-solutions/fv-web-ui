...
const approveTask = RESTActions.execute('FV_USER_TASKS_APPROVE', 'WorkflowTask.Complete', {
  headers: { 'enrichers.document': 'ancestry' },
})
const rejectTask = RESTActions.execute('FV_USER_TASKS_REJECT', 'WorkflowTask.Complete', {
  headers: { 'enrichers.document': 'ancestry' },
})
