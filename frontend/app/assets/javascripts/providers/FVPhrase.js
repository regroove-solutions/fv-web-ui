...
const fetchPhrase = RESTActions.fetch('FV_PHRASE', 'FVPhrase', {
  headers: { 'enrichers.document': 'ancestry,phrase,permissions' },
})
...
const updatePhrase = RESTActions.update(
  'FV_PHRASE',
  'FVPhrase',
  { headers: { 'enrichers.document': 'ancestry,phrase,permissions' } },
  false
...
const publishPhrase = RESTActions.execute('FV_PHRASE_PUBLISH', 'FVPublish', {
  headers: { 'enrichers.document': 'ancestry,phrase,permissions' },
})
const askToPublishPhrase = RESTActions.execute('FV_PHRASE_PUBLISH_WORKFLOW', 'Context.StartWorkflow', {
  headers: { 'enrichers.document': 'ancestry,word,permissions' },
})
const unpublishPhrase = RESTActions.execute('FV_PHRASE_UNPUBLISH', 'FVUnpublishDialect', {
  headers: { 'enrichers.document': 'ancestry,phrase,permissions' },
})
const askToUnpublishPhrase = RESTActions.execute('FV_PHRASE_UNPUBLISH_WORKFLOW', 'Context.StartWorkflow', {
  headers: { 'enrichers.document': 'ancestry,word,permissions' },
})
const enablePhrase = RESTActions.execute('FV_PHRASE_ENABLE', 'FVEnableDocument', {
  headers: { 'enrichers.document': 'ancestry,phrase,permissions' },
})
const askToEnablePhrase = RESTActions.execute('FV_PHRASE_ENABLE_WORKFLOW', 'Context.StartWorkflow', {
  headers: { 'enrichers.document': 'ancestry,word,permissions' },
})
const disablePhrase = RESTActions.execute('FV_PHRASE_DISABLE', 'FVDisableDocument', {
  headers: { 'enrichers.document': 'ancestry,phrase,permissions' },
})
const askToDisablePhrase = RESTActions.execute('FV_PHRASE_DISABLE_WORKFLOW', 'Context.StartWorkflow', {
  headers: { 'enrichers.document': 'ancestry,word,permissions' },
})
