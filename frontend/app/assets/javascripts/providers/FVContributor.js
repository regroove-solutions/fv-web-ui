...
const fetchContributor = RESTActions.fetch('FV_CONTRIBUTOR', 'FVContributor', {
  headers: { 'enrichers.document': 'ancestry' },
})
const fetchContributors = RESTActions.query('FV_CONTRIBUTORS', 'FVContributor', {
  headers: { 'enrichers.document': 'ancestry' },
})
const createContributor = RESTActions.create('FV_CONTRIBUTOR', 'FVContributor')
const updateContributor = RESTActions.update(
  'FV_CONTRIBUTOR',
  'FVContributor',
  { headers: { 'enrichers.document': 'ancestry' } },
  false
