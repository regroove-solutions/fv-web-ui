...
*/
const fetchCategory = RESTActions.fetch('FV_CATEGORY', 'FVCategory', {
  headers: { 'enrichers.document': 'ancestry, breadcrumb' },
})
const fetchCategories = RESTActions.query('FV_CATEGORIES', 'FVCategory', {
...
const updateCategory = RESTActions.update(
  'FV_CATEGORY',
  'FVCategory',
