...
const { array, func, object, oneOfType, number, string, element } = PropTypes
        ...
        componentContent = (
          <div>
            ...
            <FormContributors
              ...
              textDescription="Contributors who helped create the video."
            ...
            <FormRecorders
              ...
              textDescription="Recorders who helped create the video."
              handleItemsUpdate={(data) => {
