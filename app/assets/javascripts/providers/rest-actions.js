                ...
                if (file) {
                    return DocumentOperations.createDocumentWithBlob(parentDoc, docParams, file).then((response) => {
                        dispatch({
                            ...
                            message: IntlService.instance.translate({
        ...
        return function fetch(pathOrId, messageStart = null, messageSuccess = null, messageError = null) {
            ...
            return function (dispatch) {
                ...
                dispatch({
                    ...
                    pathOrId: pathOrId,
                    message: (messageStart || IntlService.instance.translate({
        ...
        return function update(newDoc, messageStart = undefined, messageSuccess = undefined, messageError = undefined) {
            ...
            return function (dispatch) {
                ...
                dispatch({
                    ...
                    message: ((messageStart === undefined) ? IntlService.instance.translate({
                ...
                return DocumentOperations.updateDocument(newDoc, {headers: properties.headers})
                    .then((response) => {
                        dispatch({
                            ...
                            message: ((messageSuccess === undefined) ? IntlService.instance.translate({
                ...
                return DocumentOperations.executeOperation(pathOrId, "Document.FollowLifecycleTransition", {'value': 'delete'})
                    .then((response) => {
                        dispatch({
                            ...
                            message: (messageSuccess || IntlService.instance.translate({
                                key: 'providers.document_deleted_successfully',
                                default: 'Document deleted successfully', case: 'first'
                            }) + '!'),
                            response: response,
                            pathOrId: pathOrId
                        })
