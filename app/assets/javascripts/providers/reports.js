...
const actions = { fetchReportDocuments, fetchReportWordsAll, fetchReportPhrasesAll, fetchReportSongsAll, fetchReportStoriesAll };
...
const reducers = {
	...
	computeReportWordsAll(state = { isFetching: false, response: { get: function() { return ''; } }, success: false }, action) {
		switch (action.type) {
	...
	computeReportPhrasesAll(state = { isFetching: false, response: { get: function() { return ''; } }, success: false }, action) {
		switch (action.type) {
	...
	computeReportSongsAll(state = { isFetching: false, response: { get: function() { return ''; } }, success: false }, action) {
		switch (action.type) {
	...
	computeReportStoriesAll(state = { isFetching: false, response: { get: function() { return ''; } }, success: false }, action) {
		switch (action.type) {
