...
export default function withFilter(ComposedFilter, DefaultFetcherParams) {
  class FilteredGridList extends Component {
    ...
    render() {
      ...
      if (this.props.area) {
        let fields = Map(options.get("fields")).map(
          function(field) {
            ...
            >
              <form onSubmit={this._onFilterSaveForm}>
                ...
                >
                  ...
                  />{" "}
                  &nbsp;
                  <RaisedButton type="submit" label={intl.trans("filter", "Filter", "first")} primary={true} />
                </FiltersWithToggle>
              </form>
            </div>
