                        ...
                        <div className="form-horizontal" style={{padding: '0 15px'}}>
                            ...
                            <form onSubmit={this._onRequestSaveForm.bind(this, computeItem)}>
                                ...
                                <div className="form-group" style={{textAlign: 'right'}}>
                                    ...
                                    <FlatButton onTouchTap={this._onRequestCancelForm} style={{marginRight: '10px'}} label="Cancel" />                                    
                                    <RaisedButton onTouchTap={this._onRequestSaveForm.bind(this, computeItem)} primary={true} label="Save" />
                                    ...
                                    <Popover
                                        ...
                                        <div style={{padding: '10px', margin: '0 15px', borderRadius: '5px'}}>
                                            ...
                                            <FlatButton style={confirmationButtonsStyle} onTouchTap={this._onRequestCancelForm.bind(this, true)} label="Yes!" />
                                            <FlatButton style={confirmationButtonsStyle} onTouchTap={() => this.setState({showCancelWarning: false})} label="No" />
                                        </div>
                                    </Popover>
