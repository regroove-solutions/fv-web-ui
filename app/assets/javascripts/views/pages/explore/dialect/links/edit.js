...
export default class Edit extends Component {
  ...
  render() {
    ...
    if (selectn("response", computeDialect2) && selectn("response", computeLink)) {
      ...
      context = Object.assign(selectn("response", computeDialect2), { otherContext: { 'parentId' : selectn("response.uid", computeLink), 'providedFilter': providedFilter } });
    }

    return <div>

	    <h1>Edit {selectn("response.properties.dc:title", computeLink)} link</h1>
