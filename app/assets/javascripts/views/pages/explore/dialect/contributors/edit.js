...
export default class Edit extends Component {
  ...
  render() {
    ...
    if (selectn("response", computeDialect2) && selectn("response", computeContributor)) {
      ...
      context = Object.assign(selectn("response", computeDialect2), { otherContext: { 'parentId' : selectn("response.uid", computeContributor), 'providedFilter': providedFilter } });
    }

    return <div>

	    <h1>Edit {selectn("response.properties.dc:title", computeContributor)} contributor</h1>
