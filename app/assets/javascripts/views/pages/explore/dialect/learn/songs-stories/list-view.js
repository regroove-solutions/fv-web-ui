...
class CardView extends Component {
  ...
  render() {
    ...
    let translated_continue_label_key =
          ...
          <CardMedia
            overlay={
              <CardTitle
                ...
                title={<span dangerouslySetInnerHTML={{ __html: DOMPurify.sanitize(this.props.item.title) }} />}
                subtitle={(selectn("properties.fvbook:title_literal_translation", this.props.item) || []).map(function(
                  translation,
                  i
                ) {
                  if (translation.language == DEFAULT_LANGUAGE) {
