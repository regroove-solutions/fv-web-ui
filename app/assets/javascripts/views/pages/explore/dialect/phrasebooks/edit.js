...
export default class Edit extends Component {
  ...
  render() {
    ...
    if (selectn("response", computeDialect2) && selectn("response", computeCategory)) {
      ...
      context = Object.assign(selectn("response", computeDialect2), { otherContext: { 'parentId' : selectn("response.uid", computeCategory), 'providedFilter': providedFilter } });
    }

    return <div>

	    <h1>Edit {selectn("response.properties.dc:title", computeCategory)} phraseBook</h1>
