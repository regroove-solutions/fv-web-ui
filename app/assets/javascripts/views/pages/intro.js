                ...
                <div className="row">
                    <div className={classNames('col-xs-12')} style={{textAlign: 'center', padding: '15px 0'}}>
                        <a href="http://www.fpcc.ca/" target="_blank">
                            <img src="/assets/images/logos/fphlcc-logo_sm.gif" alt="First Peoples' Heritage Language and Culture Council " width="145" height="36" hspace="5" border="0" align="absmiddle"/>
                        </a> &nbsp; 
                        <a href="http://www.fpcf.ca/" target="_blank">
                            <img src="/assets/images/logos/fpcf-logo_sm.gif" alt="First Peoples' Cultural Foundation   " width="199" height="36" hspace="5" border="0" align="absmiddle"/>
                        </a>
                        <p style={{padding: '15px 0'}}>We gratefully acknowledge the following supporters:</p>
                        <a href="http://www.gov.bc.ca/arr/" target="_blank">
                            <img src="/assets/images/logos/BC_ARR_H.jpg" alt="Ministry of Aboriginal Relations and Reconcilation" width="127" height="36" border="0" align="absmiddle"/>
                        </a> &nbsp; 
                        <a href="http://www.pch.gc.ca/" target="_blank">
                            <img src="/assets/images/logos/logo_pch.gif" alt="Canadian Heritage" width="180" height="36" border="0" align="absmiddle"/>
                        </a> &nbsp; 
                        <a href="http://www.fntc.info/" target="_blank">
                            <img src="/assets/images/logos/FNTC.gif" alt="First Nation Technology Council" width="88" height="87" border="0"/>
                        </a> &nbsp; 
                        <a href="http://www.newrelationshiptrust.ca/" target="_blank">
                            <img src="/assets/images/logos/New-NRT-Logo-sm.jpg" alt="New Relationship Trust" width="126" height="88" border="0" align="absmiddle"/>
                        </a> &nbsp; 
                            
                        <a href="http://www.languagegeek.com" target="_blank"><img src="/assets/images/logos/lg.gif" alt="Languagegeek.com" width="191" height="36" border="0"/></a> &nbsp; 
                        
                        <a href="http://www.tavultesoft.com/" target="_blank"><img src="/assets/images/logos/tav.gif" alt="Tavultesoft" width="191" height="29" border="0"/></a>
                    </div>
                </div>
