...
public final class FVExportConstants {
    ...
    public static final String PRODUCE_FORMATTED_DOCUMENT = "produceFormattedDocument"; // start of worker by user
                                                                                        // action

    public static final String FINISH_EXPORT_BY_WRAPPING_BLOB = "produceWrappedBlob"; // trigger event for starting of
                                                                                      // export worker

    public static final String AUTO_PRODUCE_FORMATTED_DOCUMENT = "autoProduceFormattedDocument"; // cron event to
                                                                                                 // trigger cyclic
                                                                                                 // worker
    ...
    public static final String ON_DEMAND_WORKER_CATEGORY = ON_DEMAND_WORKER_QUEUE_ID; // queue ID for user triggered
                                                                                      // worker
    ...
    // public static final String[] imageCompund = { ExportCSVLabels.IMG_TITLE, ExportCSVLabels.IMG_FILENAME,
    // ExportCSVLabels.IMG_DESCRIPTION, ExportCSVLabels.IMG_SHARED_WITH_OTHER_DIALECTS, ExportCSVLabels.IMG_SOURCE,
    // ExportCSVLabels.IMG_RECORDER };
    // public static final String[] videoCompund = { ExportCSVLabels.VIDEO_TITLE, ExportCSVLabels.VIDEO_FILENAME,
    // ExportCSVLabels.VIDEO_DESCRIPTION, ExportCSVLabels.VIDEO_SHARED_WITH_OTHER_DIALECTS,
    // ExportCSVLabels.VIDEO_SOURCE, ExportCSVLabels.VIDEO_RECORDER};
    // public static final String[] audioCompund = { ExportCSVLabels.AUDIO_TITLE, ExportCSVLabels.AUDIO_FILENAME,
    // ExportCSVLabels.AUDIO_DESCRIPTION, ExportCSVLabels.AUDIO_SHARED_WITH_OTHER_DIALECTS,
    // ExportCSVLabels.AUDIO_SOURCE, ExportCSVLabels.AUDIO_RECORDER };
